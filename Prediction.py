...
import Models
from Models import UNet, AttU_Net
import os
import glob
...
# weights_path = r'weights/2020_Aug_05_19_43_epoch15.pth'
# net = UNet(1)
# net.load_state_dict(torch.load(weights_path))
# _single_pred(imgs_dir+'033.648_11_5.png',net)


# 033.648_7_0.png 033.648_3_4.png 033.648_11_5.png
...
def dir_c2b(img_dir, rst_dir, is_bin=False):
    ...
    # weights_path = r'E:\Project\Unet-vanilla\weights_backup\2021_Mar_14_11_01_AUTO2.pth'  # 保存的模型文件路径
    net = AttU_Net()
    weights_path = r'E:\Project\Unet-vanilla\weights_backup\2021_May_20_15_Attention UNet_BestResult.pth'  # 保存的模型文件路径
    ...
    for img_name in tqdm(imgs_list):
        ...
        _generate_rst_img(pth, rst_dir, net, device, patch_size=256, mag_scale=2.5,is_bin=is_bin)

dir_c2b(r'E:\temp\prediction_result\DIBCO_Pridiction\ori7', r'E:\temp\prediction_result\DIBCO_Pridiction\attunet_dibco_best',True)
